...
## 01.0 Code review
This code review session will get the simple circle<>circle collision that we hacked togheter last week,
...
Starting from the reviewed example, let's crank up the number of entities and see what happens.
...
```
- after a collision is detected between two entities, decide how to handle it depending on the entity info
